...
pub fn generat_random_weapon() -> ItemsTypes{
    ...
    ItemsTypes::WeaponItem(WeaponItem::new(weapon.get::<_,String>(1),weapon.get::<_,String>(2),Raritys::from(weapon.get::<_,String>(3)),weapon.get::<_,i32>(4) as u8, weapon.get::<_, i32>(5) as i8))
...
pub fn generate_random_treaure() -> ItemsTypes{
    ...
    ItemsTypes::TreasureItem(TreasureItem::new(treasure.get::<_,String>(1), Equipmintslots::None, treasure.get::<_,String>(2), treasure.get::<_,String>(3), Raritys::from(treasure.get::<_,String>(4)), treasure.get::<_, i32>(5) as i8))
